  ...
  return (
    <div className="min-h-screen bg-gray-50 px-4 py-6">
        <div className="mx-auto max-w-md rounded-lg bg-white shadow-sm">
            <div className="flex items-cenetr gap-4 border-b p-5">
                <div className="flex h-14 w-14 items-center justify-center rounded-full bg-red-500 text-xl text-white ">{firstLetter}</div>
                <div className="text-lg font-semibold">
                    <h2 className="textlg font-semibold">{user?.name} </h2>
                    <p className="text-sm text-gay-500">{user?.email} </p>
                </div>
            </div>
