...
const Orders = () => {
    ...
    const completedOrders=orders.filter((o)=>!(ACTIVE_STATUSES as readonly string[]).includes(o.status));    
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-6 space-y-6">
        ...
        <section className="space-y-3">
            ...
            {activeOrders.length===0? <p className="">No Active Orders</p>:activeOrders.map((order)=>(
        ...
        <section className="space-y-3">
            ...
            {completedOrders.length===0? (
                <p className="">No Completed Orders</p>
            ):(
