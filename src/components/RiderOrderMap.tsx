...
declare module "leaflet"{
    namespace Routing {
        function control(optons:any):any;
        function osrmv1(optons:any):any;
    }
}
...
const RiderOrderMap = ({order}:props) => {
    ...
    return (
        <div className="rounded-xl bg-white shadow-sm p-3">
            <MapContainer center={riderLocation} zoom={14} className="h-87.5 w-full rounded-lg overflow-hidden">
