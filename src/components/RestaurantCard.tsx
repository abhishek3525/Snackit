...
const RestaurantCard = ({id,name,image,distance,isOpen}:props) => {
  ...
  return (
    <div className={`cursor-pointer rounded-xl overflow-hidden bg-white shadow-md transition  hover:shadow-md ${!isOpen ? "opacity-80" : ""}`} onClick={()=>navigate(`/restaurant/${id}`)}>
